...
// --- CONFIGURATION ---
const VISION_ICON = "./images/Asset 6.png";
const MISSION_ICON = "./images/Asset 7.png";
    ...
    <section className="py-16 pb-32">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-center gap-10 md:gap-20 items-stretch">
        ...
        <div className="relative w-full max-w-md group">
            {/* Icon Header - Replaced Icon with Image - ENLARGED AND NO WHITE CIRCLE */}
            <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 z-10 transition-transform duration-300 group-hover:-translate-y-2">
                <img 
                    src={VISION_ICON} 
                    alt="Vision" 
                    className="w-28 h-28 md:w-32 md:h-32 object-contain drop-shadow-lg transition-transform duration-300 group-hover:scale-110"
                />
            </div>

            <div className="bg-white rounded-[2.5rem] p-8 pt-24 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] border border-gray-50 text-center h-full flex flex-col items-center hover:shadow-[0_20px_50px_-15px_rgba(0,0,0,0.15)] transition-shadow duration-300">
        ...
        {/* Mission Card */}
        <div className="relative w-full max-w-md mt-20 md:mt-0 group">
            {/* Icon Header - Replaced Icon with Image - ENLARGED AND NO WHITE CIRCLE */}
            <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 z-10 transition-transform duration-300 group-hover:-translate-y-2">
                <img 
                    src={MISSION_ICON} 
